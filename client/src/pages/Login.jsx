...
<div
  ...
  style={{
    ...
    backgroundAttachment: "fixed", // optional effect
  }}
>
      <img onClick={() => navigate('/')} src={assets.logo} alt="" className='absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer' />

      <div className='bg-slate-900 p-10 rounded-2xl shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        <h2 className='text-3xl text-white font-semibold text-center mb-3'>{state === 'Sign Up' ? 'Create Account' : 'Login '}</h2>
